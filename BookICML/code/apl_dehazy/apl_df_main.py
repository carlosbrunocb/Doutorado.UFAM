...
def main():
    ...
    drive_path = 'dataset'
    dm_path = 'dataset/hazy_depth_maps/512x512/v1'
    sp_dir = 'hazy'
    gt_dir = 'hazy_gt'
    ...
    sp_datase, gt_dataset = load_images_from_folder(drive_path,
                                                    ...
                                                    resize=True)
    dm_batch = load_batch_images_from_folder(dm_path,
                                             width=dim[0], height=dim[1],
    ...
    model_builders = {
        ...
        'apl_to_dehaze_fuction_by_regression_cnn': build_apl_to_dehaze_fuction_by_regression_cnn
    }
    ...
    train_x, train_m, train_y = img_train[train_ix], img_dm[train_ix], img_gt[train_ix]
    test_x, test_m, test_y = img_train[test_ix], img_dm[test_ix], img_gt[test_ix]
    ...
    # predicted_img, predictions_params = model.predict([img_train, img_dm])
